-- Liquibase SQL Changelog for Initial Schema (MySQL)
-- ChangeSet: 001-initial-schema-mysql
-- Database: MySQL 8+
...
-- ChangeSet for Task Completions Table
...
-- ChangeSet for Reward Redemptions Table
...
-- ChangeSet for Lottery Themes Table
...
-- ChangeSet for Lottery Prizes Table
...
-- ChangeSet for Lottery Draws Table
...
-- ChangeSet for Lottery Draw Results Table
...
-- ChangeSet for Point History Table
...
-- ChangeSet for Penalty Rules Table
...
-- ChangeSet for Penalty Records Table
...
-- ChangeSet for Penalty Notifications Table
