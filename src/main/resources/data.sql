...
('完成作业', '按时完成学校作业', 10, 'DAILY_ONCE', 'APPROVED', 1, 1, true),
('打扫房间', '整理自己的房间', 5, 'REPEATABLE', 'APPROVED', 1, 1, true),
('阅读书籍', '每天阅读30分钟课外书', 8, 'DAILY_ONCE', 'APPROVED', 1, 1, true),
('帮助做家务', '帮忙洗碗或扫地', 7, 'REPEATABLE', 'APPROVED', 1, 1, true);
